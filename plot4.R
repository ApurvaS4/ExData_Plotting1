...
# Plot 1
plot(Household_energy[, Date_Time], Household_energy[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(Household_energy[, Date_Time], Household_energy[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
# Plot 4
plot(Household_energy[, Date_Time], Household_energy[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
